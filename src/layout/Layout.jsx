...
// router-dom provee lugra donde se está entre los enlaces de la pagina, el tipo de recarga Link. Outlet, 
//enlaces externos, que dependen de navegador. En vez de ref se usa to.